...
namespace Chef.DAL.Migrations
{
    ...
    [Migration("20211120143435_AddUserProductListRelation")]
    partial class AddUserProductListRelation
    {
            ...
            modelBuilder.Entity("Chef.DAL.Entities.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 20, 14, 34, 35, 482, DateTimeKind.Utc).AddTicks(563),
